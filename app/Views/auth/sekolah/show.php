        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="card box-shadow-xl overflow-hidden">
                    <div class="row">
                        <div class="col-lg-5 position-relative" style="background-image: url('<?= base_url() ?>assets/images/sekolah/1681264826_6546c23fb99d36776a91.jpg'); background-position: center; background-size: cover; background-repeat: no-repeat;" loading="lazy">
