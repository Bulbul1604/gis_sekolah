  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
      <div class="sidenav-header">
          ...
          <a class="navbar-brand m-0 mt-3" href="<?= site_url('/') ?>">
              <span class="font-weight-bold d-flex align-items-center text-sm gap-2"><i class="fas fa-map-marker-alt text-sm" style="color: #344767;"></i> Geografis Sekolah Bontang</span>
          </a>
      </div>
